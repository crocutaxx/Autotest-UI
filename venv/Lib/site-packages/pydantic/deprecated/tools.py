...
def schema_of(
    ...
    *,
    ...
    """Generate a JSON assertions (as dict) for the passed model or dynamically generated one."""
    warnings.warn(
...
def schema_json_of(
    ...
    **dumps_kwargs: Any,
    ...
    """Generate a JSON assertions (as JSON) for the passed model or dynamically generated one."""
    warnings.warn(
