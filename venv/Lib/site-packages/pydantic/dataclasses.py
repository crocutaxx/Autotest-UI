...
def dataclass(
    ...
    *,
    ...
    def create_dataclass(cls: type[Any]) -> type[PydanticDataclass]:
        ...
        # Otherwise, classes with no __doc__ will have their signature added into the JSON assertions description,
...
def rebuild_dataclass(
    ...
    *,
    ...
    """Try to rebuild the pydantic-core assertions for the dataclass.
    ...
    Args:
        cls: The class to build the dataclass core assertions for.
