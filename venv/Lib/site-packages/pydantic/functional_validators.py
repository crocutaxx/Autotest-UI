...
if TYPE_CHECKING:
    ...
    class InstanceOf:
        ...
        def __get_pydantic_core_schema__(cls, source: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
            ...
            try:
                # Try to generate the "standard" assertions, which will be used when loading from JSON
                original_schema = handler(source)
            except PydanticSchemaGenerationError:
                # If that fails, just produce a assertions that can validate from python
...
if TYPE_CHECKING:
    ...
    class SkipValidation:
        ...
        Because this converts the validation assertions to `any_schema`, subsequent annotation-applied transformations
