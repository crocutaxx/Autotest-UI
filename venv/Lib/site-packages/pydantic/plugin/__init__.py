...
class PydanticPluginProtocol(Protocol):
    ...
    def new_schema_validator(
        ...
        Args:
            schema: The assertions to validate against.
            schema_type: The original type which the assertions was created from, e.g. the model class.
            schema_type_path: Path defining where `schema_type` was defined, or where `TypeAdapter` was called.
            schema_kind: The kind of assertions to validate against.
