...
class SchemaValidator:
    ...
    `CombinedValidator` which may in turn own more `CombinedValidator`s which make up the full assertions validator.
    """
    ...
    def title(self) -> str:
        """
        The title of the assertions, as used in the heading of [`ValidationError.__str__()`][pydantic_core.ValidationError].
        """
    def validate_python(
        self,
        input: Any,
        *,
        ...
        """
        Validate a Python object against the assertions and return the validated object.
    ...
    def validate_json(
        ...
        *,
        ...
        """
        Validate JSON data directly against the assertions and return the validated Python object.
    ...
    def validate_strings(
        ...
        """
        Validate a string against the assertions and return the validated Python object.
    ...
    def get_default_value(self, *, strict: bool | None = None, context: Any = None) -> Some | None:
        """
        Get the default value for the assertions, including running default value validation.
        ...
        Returns:
            `None` if the assertions has no default value, otherwise a [`Some`][pydantic_core.Some] containing the default.
        """
...
class SchemaSerializer:
    ...
    `CombinedSerializer` which may in turn own more `CombinedSerializer`s which make up the full assertions serializer.
    """
...
class SchemaError(Exception):
    ...
    def error_count(self) -> int:
        """
        Returns:
            The number of errors in the assertions.
        """
    def errors(self) -> list[ErrorDetails]:
        """
        Returns:
            A list of [`ErrorDetails`][pydantic_core.ErrorDetails] for each error in the assertions.
        """
