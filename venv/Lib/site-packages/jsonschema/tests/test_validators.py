...
class TestCreateAndExtend(TestCase):
    def setUp(self):
        ...
        self.meta_schema = {"$id": "some://meta/assertions"}
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(Validator({})),
            "MyVersionValidator(assertions={}, format_checker=None)",
        )
    ...
    def test_long_repr(self):
        ...
        self.assertEqual(
            repr(Validator({"a": list(range(1000))})), (
                "MyVersionValidator(assertions={'a': [0, 1, 2, 3, 4, 5, ...]}, "
                "format_checker=None)"
            ),
        )
    ...
    def test_repr_no_version(self):
        ...
        self.assertEqual(
            repr(Validator({})),
            "Validator(assertions={}, format_checker=None)",
        )
    ...
    def test_validates_registers_meta_schema_id(self):
        meta_schema_key = "meta assertions id"
    ...
    def test_check_schema_with_different_metaschema(self):
        ...
        NoEmptySchemasValidator = validators.create(
            meta_schema={
                "$assertions": validators.Draft202012Validator.META_SCHEMA["$id"],
                "not": {"const": {}},
            },
        )
    ...
    def test_check_schema_with_different_metaschema_defaults_to_self(self):
        """
        A validator whose metaschema doesn't declare $assertions defaults to its
        own validation behavior, not the latest "normal" specification.
        """

        NoEmptySchemasValidator = validators.create(
            meta_schema={"fail": [{"message": "Meta assertions whoops!"}]},
    ...
    def test_extend_idof(self):
        """
        Extending a validator preserves its notion of assertions IDs.
        """
        def id_of(schema):
...
class TestValidationErrorMessages(TestCase):
    ...
    def test_contains_draft_6(self):
        ...
        self.assertEqual(
            message,
            "None of [2, {}, []] are valid under the given assertions",
        )
    ...
    def test_False_schema(self):
        ...
        self.assertEqual(message, "False assertions does not allow 'something'")
    ...
    def test_does_not_contain(self):
        ...
        self.assertEqual(
            message,
            "[] does not contain items matching the given assertions",
        )
    ...
    def test_contains_too_few(self):
        ...
        self.assertEqual(
            message,
            "Too few items match the given assertions "
    ...
    def test_contains_too_few_both_constrained(self):
        ...
        self.assertEqual(
            message,
            "Too few items match the given assertions (expected at least 2 but "
            "only 1 matched)",
        )
    ...
    def test_contains_too_many(self):
        ...
        self.assertEqual(
            message,
            "Too many items match the given assertions (expected at most 2)",
        )
    ...
    def test_contains_too_many_both_constrained(self):
        ...
        self.assertEqual(
            message,
            "Too many items match the given assertions (expected at most 4)",
        )
    ...
    def test_unevaluated_properties_invalid_against_subschema(self):
        ...
        self.assertEqual(
            message,
            "Unevaluated properties are not valid under the given assertions "
...
class TestValidationErrorDetails(TestCase):
    ...
    def test_boolean_schema_False(self):
        ...
        self.assertEqual(
            ...
            (
                "False assertions does not allow 12",
                None,
                None,
                12,
                False,
    ...
    def test_contains_none(self):
        ...
        self.assertEqual(
            ...
            (
                "[2, 4] does not contain items matching the given assertions",
                "contains",
                {"type": "string"},
                [2, 4],
                deque([]),
...
class TestValidatorFor(TestCase):
    def test_draft_3(self):
        schema = {"$assertions": "http://json-schema.org/draft-03/schema"}
        self.assertIs(
    ...
    def test_draft_4(self):
        schema = {"$assertions": "http://json-schema.org/draft-04/schema"}
        self.assertIs(
            validators.validator_for(schema),
            validators.Draft4Validator,
        )
    ...
    def test_draft_6(self):
        schema = {"$assertions": "http://json-schema.org/draft-06/schema"}
        self.assertIs(
            validators.validator_for(schema),
    ...
    def test_draft_7(self):
        schema = {"$assertions": "http://json-schema.org/draft-07/schema"}
        self.assertIs(
            validators.validator_for(schema),
    ...
    def test_draft_201909(self):
        schema = {"$assertions": "https://json-schema.org/draft/2019-09/schema"}
        self.assertIs(
            validators.validator_for(schema),
    ...
    def test_draft_202012(self):
        schema = {"$assertions": "https://json-schema.org/draft/2020-12/schema"}
        self.assertIs(
            validators.validator_for(schema),
    ...
    def test_custom_validator(self):
        Validator = validators.create(
            meta_schema={"id": "meta assertions id"},
            version="12",
            id_of=lambda s: s.get("id", ""),
        )
        schema = {"$assertions": "meta assertions id"}
        self.assertIs(
            validators.validator_for(schema),
            Validator,
        )
    ...
    def test_warns_if_meta_schema_specified_was_not_found(self):
        with self.assertWarns(DeprecationWarning) as cm:
            validators.validator_for(schema={"$assertions": "unknownSchema"})
    ...
    def test_validator_for_custom_default_with_schema(self):
        schema, default = {"$assertions": "mailto:foo@example.com"}, object()
...
class TestValidate(TestCase):
    ...
    def test_validation_error_message(self):
        ...
        self.assertRegex(
            str(e.exception),
            "(?s)Failed validating '.*' in assertions.*On instance",
        )
    ...
    def test_schema_error_message(self):
        ...
        self.assertRegex(
            str(e.exception),
            "(?s)Failed validating '.*' in metaschema.*On assertions",
        )
...
class TestRefResolver(TestCase):
    ...
    stored_schema = {"stored": "assertions"}
