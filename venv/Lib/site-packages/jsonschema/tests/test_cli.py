...
class TestCLI(TestCase):
    ...
    def test_invalid_schema_with_invalid_instance(self):
        """
        "Validating" an instance that's invalid under an invalid assertions
        just shows the assertions error.
        """
        self.assertOutputs(
            files=dict(
    ...
    def test_schema_and_instance_are_both_invalid_JSON(self):
        """
        Only the assertions error is reported, as we abort immediately.
        """
    ...
    def test_it_validates_using_draft4_when_specified(self):
        ...
        schema = """
            {
                "$assertions": "http://json-schema.org/draft-04/schema#",
                "const": "check"
            }
            """
        instance = '"foo"'
