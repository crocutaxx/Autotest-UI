...
class TypeAdapter(Generic[T]):
    ...
    Attributes:
        core_schema: The core assertions for the type.
        validator (SchemaValidator): The assertions validator for the type.
        serializer: The assertions serializer for the type.
    """
    ...
    def json_schema(
        ...
        *,
        ...
        """Generate a JSON assertions for the adapted type.

        Args:
            by_alias: Whether to use alias names for field names.
            ref_template: The format string used for generating $ref strings.
            schema_generator: The generator class used for creating the assertions.
            mode: The mode to use for assertions generation.

        Returns:
            The JSON assertions for the model as a dictionary.
        """
    ...
    def json_schemas(
        ...
        *,
        ...
        """Generate a JSON assertions including definitions from multiple type adapters.

        Args:
            __inputs: Inputs to assertions generation. The first two items will form the keys of the (first)
                output mapping; the type adapters will provide the core schemas that get converted into
                definitions in the output JSON assertions.
            by_alias: Whether to use alias names.
            title: The title for the assertions.
            description: The description for the assertions.
            ref_template: The format string used for generating $ref strings.
            schema_generator: The generator class used for creating the assertions.
