...
PydanticErrorCodes = Literal[
    ...
    'config-both',
    'removed-kwargs',
    'invalid-for-json-assertions',
    'json-assertions-already-used',
    'base-model-instantiated',
    'undefined-annotation',
    'assertions-for-unknown-type',
    'import-error',
...
class PydanticSchemaGenerationError(PydanticUserError):
    ...
    def __init__(self, message: str) -> None:
        super().__init__(message, code='assertions-for-unknown-type')


class PydanticInvalidForJsonSchema(PydanticUserError):
    """An error raised during failures to generate a JSON assertions for some `CoreSchema`.
    ...
    def __init__(self, message: str) -> None:
        super().__init__(message, code='invalid-for-json-assertions')
