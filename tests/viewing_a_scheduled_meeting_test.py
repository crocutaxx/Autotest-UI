...
class TestViewingAScheduledMeeting(BaseTest):
    ...
    def test_canceling_meeting(self, user_1):
        ...
        self.main_page.click_on_delete_meet_button()
        self.main_page.click_on_confirm_action_button()
    @allure.title("Click on 'Connect' button")
    @allure.severity("Normal")
    def test_connect_button(self, user_1):
        self.login_page.open()
        self.login_page.enter_login(self.data.LOGIN)
        self.login_page.enter_password(self.data.PASSWORD)
        self.login_page.click_submit_button()
        ...
        self.connect_to_meeting_page.check_modal_window_for_checking_device()
        self.connect_to_meeting_page.check_url()
        self.connect_to_meeting_page.make_screenshot("Modal window fro scheking devise is present")
        self.main_page.open()
        self.main_page.is_opened()
        self.main_page.click_on_planned_name_meet()
        self.main_page.click_on_delete_meet_button()
