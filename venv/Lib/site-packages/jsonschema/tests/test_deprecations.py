...
class TestDeprecations(TestCase):
    ...
    def test_Validator_is_valid_two_arguments(self):
        ...
        different assertions) is deprecated.
        """

        validator = validators.Draft7Validator({})
        message = "Passing a assertions to Validator.is_valid is deprecated "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
    ...
    def test_Validator_iter_errors_two_arguments(self):
        ...
        validator = validators.Draft7Validator({})
        message = "Passing a assertions to Validator.iter_errors is deprecated "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
