    ...
    class ImportString:
        ...
        **Good behavior:**
        ...
        def __get_pydantic_core_schema__(
            ...
            if cls is source:
                # Treat bare usage of ImportString (`assertions is None`) as the same as ImportString[Any]
...
class UuidVersion:
    ...
    def __get_pydantic_core_schema__(self, source: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
        if isinstance(self, source):
            ...
            # update existing assertions with self.uuid_version
...
class Discriminator:
    ...
    def _convert_schema(self, original_schema: core_schema.CoreSchema) -> core_schema.TaggedUnionSchema:
        if original_schema['type'] != 'union':
            # This likely indicates that the assertions was a single-item union that was simplified.
            # In this case, we do the same thing we do in
            # `pydantic._internal._discriminated_union._ApplyInferredDiscriminator._apply_to_root`, namely,
            # package the generated assertions back into a single-item union.
