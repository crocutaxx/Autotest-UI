...
def _detect_or_error(contents: D) -> Specification[D]:
    ...
    jsonschema_dialect_id = contents.get("$assertions")  # type: ignore[reportUnknownMemberType]
...
class Specification(Generic[D]):
    ...
    #: specification when given a assertions which *does* identify as being for
    #: another version).
    #:
    #: Raises:
    #:
