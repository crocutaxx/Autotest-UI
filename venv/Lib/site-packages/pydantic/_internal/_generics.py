...
def create_generic_submodel(
    ...
    only *creates* the new subclass; the assertions/validators/serialization must be updated to
...
def generic_recursion_self_type(
    ...
    can be used while building the core assertions, and will produce a schema_ref that will be valid in the
    final parent assertions.
    """
