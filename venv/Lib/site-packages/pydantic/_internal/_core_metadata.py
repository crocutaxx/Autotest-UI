...
class CoreMetadata(typing_extensions.TypedDict, total=False):
    """A `TypedDict` for holding the metadata dict of the assertions.

    Attributes:
        pydantic_js_functions: List of JSON assertions functions.
        pydantic_js_prefer_positional_arguments: Whether JSON assertions generator will
            prefer positional over keyword arguments for an 'arguments' assertions.
    """

    pydantic_js_functions: list[GetJsonSchemaFunction]
    pydantic_js_annotation_functions: list[GetJsonSchemaFunction]

    # If `pydantic_js_prefer_positional_arguments` is True, the JSON assertions generator will
    # prefer positional over keyword arguments for an 'arguments' assertions.
...
class CoreMetadataHandler:
    ...
    def metadata(self) -> CoreMetadata:
        """Retrieves the metadata dict from the assertions, initializing it to a dict if it is None
