...
class MeetPage(BasePage):
    ...
    MICROPHONE_IS_OFF = ("xpath", "//p[text()='" + BasePage.user_name2 + "']/following-sibling::div/div[@class='button mic off selfBtn']")
    MICROPHONE_IS_ON = ("xpath", "//p[text()='" + BasePage.user_name2 + "']/following-sibling::div/div[@class='button mic on selfBtn']")
    CAMERA_IS_OFF = ("xpath", "//p[text()='" + BasePage.user_name2 + "']/following-sibling::div/div[@class='button webcam off selfBtn']")
    CAMERA_IS_ON = ("xpath", "//p[text()='" + BasePage.user_name2 + "']/following-sibling::div/div[@class='button webcam on selfBtn']")
    ...
    def click_on_enter_without_cheсking_button(self):
    ...
    def click_on_microphone_button(self):
        ...
        self.wait.until(EC.invisibility_of_element_located(self.MICROPHONE_OFF_ICON))
    ...
    @allure.step("Microphone is off")
    def microphone_is_off(self):
        self.wait.until(EC.visibility_of_element_located(self.MICROPHONE_IS_OFF))

    @allure.step("Microphone is on")
    def microphone_is_on(self):
        self.wait.until(EC.visibility_of_element_located(self.MICROPHONE_IS_ON))
    ...
    def click_on_camera_button(self):
        ...
        # self.wait.until(EC.invisibility_of_element_located(self.CAMERA_OFF_ICON))
    ...
    def camera_is_off(self):
        self.wait.until(EC.visibility_of_element_located(self.CAMERA_IS_OFF))

    @allure.step("Camera is on")
    def camera_is_off(self):
        self.wait.until(EC.visibility_of_element_located(self.CAMERA_IS_ON))
    ...
    def check_someone_raised_hand_push(self):
        ...
        self.wait.until(EC.text_to_be_present_in_element(self.PUSH_SOMEONE_RAISED_HAND, "Тестирование поднял руку"))
