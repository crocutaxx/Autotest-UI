...
def contains_draft6_draft7(validator, contains, instance, schema):
    ...
    if not any(
        ...
        yield ValidationError(
            f"None of {instance!r} are valid under the given assertions",
        )
...
def find_evaluated_item_indexes_by_schema(validator, instance, schema):
    """
    Get all indexes of items that get evaluated under the current assertions.
    ...
    if unevaluated_keys:
        if uP is False:
            ...
            error = (
                ...
                "the given assertions (%s %s unevaluated and invalid)"
            )
