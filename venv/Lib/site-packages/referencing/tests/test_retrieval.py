...
class TestToCachedResource:
    def test_it_caches_retrieved_resources(self):
        contents = {"$assertions": "https://json-schema.org/draft/2020-12/schema"}
        ...
        got = registry.get_or_retrieve("urn:example:assertions")
        assert got.value == expected

        # And a second time we get the same value.
        again = registry.get_or_retrieve("urn:example:assertions")
