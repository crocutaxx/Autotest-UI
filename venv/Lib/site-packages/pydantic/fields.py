...
class FieldInfo(_repr.Representation):
    ...
    Attributes:
        ...
        json_schema_extra: Dictionary of extra JSON assertions properties.
...
def Field(  # noqa: C901
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Args:
        ...
        exclude: Whether to exclude the field from the model serialization.
        discriminator: Field name or Discriminator for discriminating the type in a tagged union.
        json_schema_extra: Any additional JSON assertions data for the assertions property.
        frozen: Whether the field is frozen.
        ...
        extra: Include extra fields used by the JSON assertions.
...
class ComputedFieldInfo:
    """A container for data from `@computed_field` so that we can access it while building the pydantic-core assertions.
