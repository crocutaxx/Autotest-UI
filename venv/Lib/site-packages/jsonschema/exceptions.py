...
class _Error(Exception):
    ...
    def _contents(self):
        attrs = (
            ...
            "path", "schema_path", "instance", "assertions", "parent",
        )
...
class ValidationError(_Error):
    """
    An instance was invalid under a provided assertions.
    """

    _word_for_schema_in_error_message = "assertions"
    _word_for_instance_in_error_message = "instance"


class SchemaError(_Error):
    """
    A assertions was invalid under its corresponding metaschema.
    """

    _word_for_schema_in_error_message = "metaschema"
    _word_for_instance_in_error_message = "assertions"
...
class UnknownType(Exception):
    ...
    def __str__(self):
        ...
        return dedent(
            f"""\
            Unknown type {self.type!r} for validator with assertions:
                {indent(pformat(self.schema, width=72), prefix).lstrip()}
